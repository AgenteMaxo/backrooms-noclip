...
const CAP_SALA = 70;          // jugadores por instancia; al entrar se abre level-X::2, ::3... si se llena
...
module.exports = {
  VERSION, MAX_MSG, MAX_CHAT, COOLDOWN_MOVER, COOLDOWN_CHAT, RADIO_CHAT, CAP_SALA, CAP_POR_IP, MAX_SALA_PRIVADA,
  leer,
};
